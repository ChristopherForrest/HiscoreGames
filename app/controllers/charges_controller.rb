...
#     # puts "---- #{@book.inspect}"
#     @amount = @games.price.to_i * 100
#     application_fee = (@games * 0.05).to_i     # 5%
...
#     charge_params[:destination] = User.find(@games.user_id).stripe_id
...
#   private
#   def set_item
#     @games= Games.find(params[:games_id])
#   end
# end
